...
export type ReactiveAuthStore<TUser, TTokens> = TypedEmitter<
    ReactiveAuthStoreEvents<TUser, TTokens>
> & {
...
export type ReactivePersistance<T> = TypedEmitter<
    ReactivePersistanceEvents<T>
> & {
